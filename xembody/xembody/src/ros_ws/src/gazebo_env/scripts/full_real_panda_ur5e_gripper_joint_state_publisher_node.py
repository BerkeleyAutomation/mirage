...
class FullPandaJointStatePublisher(Node):
    ...
    def joint_commands_callback(self, msg):
        ...
        self.joint_state_msg.name = ["panda_joint1", "panda_joint2", "panda_joint3","panda_joint4", "panda_joint5", "panda_joint6","panda_joint7","robotiq_85_left_knuckle_joint","robotiq_85_right_knuckle_joint","robotiq_85_left_inner_knuckle_joint","robotiq_85_right_inner_knuckle_joint","robotiq_85_left_finger_tip_joint","robotiq_85_right_finger_tip_joint"]
        gripper_data = msg.data[-1]
        for i in range(5):
            msg.data.append(gripper_data)
