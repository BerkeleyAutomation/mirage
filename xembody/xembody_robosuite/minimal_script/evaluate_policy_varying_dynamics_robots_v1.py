...
def rollout(policy, env, horizon, render=False, video_writer=None, video_skip=5, return_obs=False, camera_names=None, use_delta=True):
    """
    ...
    env.env.robots[0].controller.use_delta = use_delta # change to absolute pose
