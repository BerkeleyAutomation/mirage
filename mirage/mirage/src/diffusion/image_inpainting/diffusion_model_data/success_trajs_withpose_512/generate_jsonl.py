...
ur5e_folder = '/home/lawrence/xembody/xembody/xembody_robosuite/image_inpainting/diffusion_model_data/success_trajs_withpose_512/ur5e_rgb'
franka_folder = '/home/lawrence/xembody/xembody/xembody_robosuite/image_inpainting/diffusion_model_data/success_trajs_withpose_512/franka_rgb'
        ...
        if len(ur5e_images) == len(franka_images):
            for ur5e_img, franka_img in zip(ur5e_images, franka_images):
                data_entry = {
                    ...
                    "conditioning_image": franka_img  # Path to UR5 image
                }
                jsonl_data.append(data_entry)

# Write data to a JSONL file
with open('paired_images_debug.jsonl', 'w') as outfile:
