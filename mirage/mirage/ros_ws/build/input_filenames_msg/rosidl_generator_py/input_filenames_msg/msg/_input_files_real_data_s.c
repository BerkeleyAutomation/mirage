...
bool input_filenames_msg__msg__input_files_real_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("input_filenames_msg.msg._input_files_real_data.InputFilesRealData", full_classname_dest, 65) == 0);
  }
  input_filenames_msg__msg__InputFilesRealData * ros_message = _ros_message;
  {  // rgb
...
{
  /* NOTE(esteve): Call constructor of InputFilesRealData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("input_filenames_msg.msg._input_files_real_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InputFilesRealData");
