...
#include "input_filenames_msg/msg/detail/input_files_diffusion_data__rosidl_typesupport_fastrtps_c.h"
...
using _InputFilesDiffusionData__ros_msg_type = input_filenames_msg__msg__InputFilesDiffusionData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _InputFilesDiffusionData__ros_msg_type * ros_message = static_cast<const _InputFilesDiffusionData__ros_msg_type *>(untyped_ros_message);
  // Field name: rgb
  {
  ...
  void * untyped_ros_message)
{
  ...
  _InputFilesDiffusionData__ros_msg_type * ros_message = static_cast<_InputFilesDiffusionData__ros_msg_type *>(untyped_ros_message);
  // Field name: rgb
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_input_filenames_msg__msg__InputFilesDiffusionData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InputFilesDiffusionData__ros_msg_type * ros_message = static_cast<const _InputFilesDiffusionData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _InputFilesDiffusionData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_input_filenames_msg__msg__InputFilesDiffusionData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_input_filenames_msg
size_t max_serialized_size_input_filenames_msg__msg__InputFilesDiffusionData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _InputFilesDiffusionData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_input_filenames_msg__msg__InputFilesDiffusionData(
...
static message_type_support_callbacks_t __callbacks_InputFilesDiffusionData = {
...
static rosidl_message_type_support_t _InputFilesDiffusionData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_InputFilesDiffusionData,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, input_filenames_msg, msg, InputFilesDiffusionData)() {
  return &_InputFilesDiffusionData__type_support;
}
