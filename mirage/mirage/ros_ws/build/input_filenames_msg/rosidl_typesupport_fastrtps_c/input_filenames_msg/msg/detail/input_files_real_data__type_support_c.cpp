...
#include "input_filenames_msg/msg/detail/input_files_real_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // depth_map, joints
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // depth_map, joints
...
using _InputFilesRealData__ros_msg_type = input_filenames_msg__msg__InputFilesRealData;

static bool _InputFilesRealData__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _InputFilesRealData__ros_msg_type * ros_message = static_cast<const _InputFilesRealData__ros_msg_type *>(untyped_ros_message);
  // Field name: rgb
  {
...
static bool _InputFilesRealData__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _InputFilesRealData__ros_msg_type * ros_message = static_cast<_InputFilesRealData__ros_msg_type *>(untyped_ros_message);
  // Field name: rgb
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _InputFilesRealData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_input_filenames_msg__msg__InputFilesRealData(
...
static size_t _InputFilesRealData__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_input_filenames_msg__msg__InputFilesRealData(
...
static message_type_support_callbacks_t __callbacks_InputFilesRealData = {
  "input_filenames_msg::msg",
  "InputFilesRealData",
  _InputFilesRealData__cdr_serialize,
  _InputFilesRealData__cdr_deserialize,
  _InputFilesRealData__get_serialized_size,
  _InputFilesRealData__max_serialized_size
};

static rosidl_message_type_support_t _InputFilesRealData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_InputFilesRealData,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, input_filenames_msg, msg, InputFilesRealData)() {
  return &_InputFilesRealData__type_support;
}
