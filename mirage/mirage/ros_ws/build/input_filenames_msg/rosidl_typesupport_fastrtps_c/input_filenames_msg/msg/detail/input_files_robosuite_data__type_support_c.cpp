...
#include "input_filenames_msg/msg/detail/input_files_robosuite_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // depth_map, joints, rgb
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // depth_map, joints, rgb
...
using _InputFilesRobosuiteData__ros_msg_type = input_filenames_msg__msg__InputFilesRobosuiteData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _InputFilesRobosuiteData__ros_msg_type * ros_message = static_cast<const _InputFilesRobosuiteData__ros_msg_type *>(untyped_ros_message);
  // Field name: rgb
  {
  ...
  void * untyped_ros_message)
{
  ...
  _InputFilesRobosuiteData__ros_msg_type * ros_message = static_cast<_InputFilesRobosuiteData__ros_msg_type *>(untyped_ros_message);
  // Field name: rgb
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_input_filenames_msg__msg__InputFilesRobosuiteData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InputFilesRobosuiteData__ros_msg_type * ros_message = static_cast<const _InputFilesRobosuiteData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _InputFilesRobosuiteData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_input_filenames_msg__msg__InputFilesRobosuiteData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_input_filenames_msg
size_t max_serialized_size_input_filenames_msg__msg__InputFilesRobosuiteData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _InputFilesRobosuiteData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_input_filenames_msg__msg__InputFilesRobosuiteData(
...
static message_type_support_callbacks_t __callbacks_InputFilesRobosuiteData = {
...
static rosidl_message_type_support_t _InputFilesRobosuiteData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_InputFilesRobosuiteData,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, input_filenames_msg, msg, InputFilesRobosuiteData)() {
  return &_InputFilesRobosuiteData__type_support;
}
