...
#include "input_filenames_msg/msg/detail/multiple_inpaint_images__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const input_filenames_msg::msg::MultipleInpaintImages *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<input_filenames_msg::msg::MultipleInpaintImages *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MultipleInpaintImages__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const input_filenames_msg::msg::MultipleInpaintImages *>(
...
static size_t _MultipleInpaintImages__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MultipleInpaintImages(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MultipleInpaintImages__callbacks = {
...
static rosidl_message_type_support_t _MultipleInpaintImages__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MultipleInpaintImages__callbacks,
...
{
  return &input_filenames_msg::msg::typesupport_fastrtps_cpp::_MultipleInpaintImages__handle;
}
