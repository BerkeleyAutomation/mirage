...
#include "input_filenames_msg/msg/detail/input_files_sim_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const input_filenames_msg::msg::InputFilesSimData & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.interpolated_gripper;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  input_filenames_msg::msg::InputFilesSimData & ros_message)
{
  // Member: rgb
  ...
  size_t current_alignment)
{
  ...
  // Member: segmentation
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.segmentation[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: ee_pose
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.ee_pose[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: interpolated_gripper
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.interpolated_gripper[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_input_filenames_msg
max_serialized_size_InputFilesSimData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const input_filenames_msg::msg::InputFilesSimData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<input_filenames_msg::msg::InputFilesSimData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _InputFilesSimData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const input_filenames_msg::msg::InputFilesSimData *>(
...
static size_t _InputFilesSimData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_InputFilesSimData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _InputFilesSimData__callbacks = {
...
static rosidl_message_type_support_t _InputFilesSimData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_InputFilesSimData__callbacks,
...
{
  return &input_filenames_msg::msg::typesupport_fastrtps_cpp::_InputFilesSimData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, input_filenames_msg, msg, InputFilesSimData)() {
  return &input_filenames_msg::msg::typesupport_fastrtps_cpp::_InputFilesSimData__handle;
}
