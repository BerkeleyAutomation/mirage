...
class Metaclass_InputFilesRealData(type):
    """Metaclass of message 'InputFilesRealData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__input_files_real_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__input_files_real_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__input_files_real_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__input_files_real_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__input_files_real_data
...
class InputFilesRealData(metaclass=Metaclass_InputFilesRealData):
    """Message class 'InputFilesRealData'."""
