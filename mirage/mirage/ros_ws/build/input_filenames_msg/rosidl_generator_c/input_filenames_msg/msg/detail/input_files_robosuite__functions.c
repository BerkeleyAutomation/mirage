...
input_filenames_msg__msg__InputFilesRobosuite__init(input_filenames_msg__msg__InputFilesRobosuite * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->rgb)) {
    input_filenames_msg__msg__InputFilesRobosuite__fini(msg);
    return false;
  }
  // depth
...
input_filenames_msg__msg__InputFilesRobosuite__create()
{
  ...
  input_filenames_msg__msg__InputFilesRobosuite * msg = (input_filenames_msg__msg__InputFilesRobosuite *)allocator.allocate(sizeof(input_filenames_msg__msg__InputFilesRobosuite), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(input_filenames_msg__msg__InputFilesRobosuite));
  bool success = input_filenames_msg__msg__InputFilesRobosuite__init(msg);
  if (!success) {
...
input_filenames_msg__msg__InputFilesRobosuite__Sequence__init(input_filenames_msg__msg__InputFilesRobosuite__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  input_filenames_msg__msg__InputFilesRobosuite * data = NULL;

  if (size) {
    data = (input_filenames_msg__msg__InputFilesRobosuite *)allocator.zero_allocate(size, sizeof(input_filenames_msg__msg__InputFilesRobosuite), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = input_filenames_msg__msg__InputFilesRobosuite__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        input_filenames_msg__msg__InputFilesRobosuite__fini(&data[i - 1]);
      }
...
input_filenames_msg__msg__InputFilesRobosuite__Sequence__fini(input_filenames_msg__msg__InputFilesRobosuite__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      input_filenames_msg__msg__InputFilesRobosuite__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  input_filenames_msg__msg__InputFilesRobosuite__Sequence * array = (input_filenames_msg__msg__InputFilesRobosuite__Sequence *)allocator.allocate(sizeof(input_filenames_msg__msg__InputFilesRobosuite__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = input_filenames_msg__msg__InputFilesRobosuite__Sequence__init(array, size);
  if (!success) {
...
input_filenames_msg__msg__InputFilesRobosuite__Sequence__destroy(input_filenames_msg__msg__InputFilesRobosuite__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    input_filenames_msg__msg__InputFilesRobosuite__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
input_filenames_msg__msg__InputFilesRobosuite__Sequence__are_equal(const input_filenames_msg__msg__InputFilesRobosuite__Sequence * lhs, const input_filenames_msg__msg__InputFilesRobosuite__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!input_filenames_msg__msg__InputFilesRobosuite__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  input_filenames_msg__msg__InputFilesRobosuite__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(input_filenames_msg__msg__InputFilesRobosuite);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    input_filenames_msg__msg__InputFilesRobosuite * data =
      (input_filenames_msg__msg__InputFilesRobosuite *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!input_filenames_msg__msg__InputFilesRobosuite__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          input_filenames_msg__msg__InputFilesRobosuite__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!input_filenames_msg__msg__InputFilesRobosuite__copy(
