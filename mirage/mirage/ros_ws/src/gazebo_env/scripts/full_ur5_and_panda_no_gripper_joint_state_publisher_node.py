...
class FullUR5EJointStatePublisher(Node):
    def __init__(self):
        super().__init__('full_ur5_and_panda_no_gripper_joint_state_publisher')
    ...
    def joint_commands_callback(self, msg):
        ...
        self.joint_state_msg.name = ["shoulder_pan_joint", "shoulder_lift_joint", "elbow_joint","wrist_1_joint", "wrist_2_joint", "wrist_3_joint","panda_joint1", "panda_joint2", "panda_joint3","panda_joint4", "panda_joint5", "panda_joint6","panda_joint7"]  # Replace with your joint names
