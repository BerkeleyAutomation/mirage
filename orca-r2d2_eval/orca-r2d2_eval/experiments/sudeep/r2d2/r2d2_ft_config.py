...
def get_config(config_string="full,multimodal"):
    ...
    FINETUNING_KWARGS = {
        ...
        "absolute_action_mask": [False] * 3 + [True] * 7,
        "action_normalization_mask": [True] * 9 + [False],
        # standardize_fn is dynamically loaded from a file
        # for example: "experiments/kevin/custom_standardization_transforms.py:aloha_dataset_transform"
        "standardize_fn": "experiments.sudeep.r2d2.standardization_transforms:r2_d2_dataset_wristact_transform",
    ...
    grad_accum = 2
    batch_size = int(256 / grad_accum) if grad_accum else 256
    max_steps = FieldReference(grad_accum * 50000) if grad_accum is not None \
                else FieldReference(50000)
